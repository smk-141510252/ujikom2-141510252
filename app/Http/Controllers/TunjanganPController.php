...
class TunjanganPController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('TunjanganPeg.index',compact('tp'));
    }
    ...
    public function create()
    {
        $tp = Tunjangans::all();
        $pegawai = Pegawai::all();
        return view('TunjanganPeg.create',compact('tp','pegawai')); 
    }
    ...
    public function show($id)
    {
        ...
        $tp = Tunjangans::all();
        $pegawai = Pegawai::all();
        return view('TunjanganPeg.show',compact('data','tp','pegawai'));
    }
    ...
    public function edit($id)
    {
       $data = Tunjangan_pegawai::find($id);
        $tp = Tunjangans::all();
        $pegawai = Pegawai::all();
        return view('TunjanganPeg.edit',compact('data','tp','pegawai'));
    }
